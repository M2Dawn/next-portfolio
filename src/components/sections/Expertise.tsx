            ...
            <SpotlightCard className="h-full rounded-[2rem]" spotlightColor="rgba(34,72,163,0.15)">
              <div className="group bg-[#0A0A0C] border border-white/5 rounded-[2rem] p-8 lg:p-10 flex flex-col hover:bg-[#0F0F13] hover:border-brand/30 hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(34,72,163,0.1)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] h-full relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.04)]">
                ...
                <div className="w-full h-[3px] bg-white/5 rounded-full mb-8 overflow-hidden">
                  <div className="h-full relative" style={{ width: '92%', background: 'linear-gradient(to right, #2248A3, #7898E6)' }}>
                    <div className="absolute inset-0 bg-white/20 animate-[scanlineMove_2s_linear_infinite]"></div>
                  </div>
                </div>
                
                <h3 className="font-heading text-xl font-bold text-white mb-4 group-hover:text-brand transition-colors duration-300">Revit API Development</h3>
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  <span className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-mono text-text-2 group-hover:border-brand/20 group-hover:text-text-1 transition-all duration-300">C#</span>
                  <span className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-mono text-text-2 group-hover:border-brand/20 group-hover:text-text-1 transition-all duration-300">.NET 4.8+</span>
                  <span className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-mono text-text-2 group-hover:border-brand/20 group-hover:text-text-1 transition-all duration-300">WPF</span>
                </div>
          ...
          <Reveal delay={200} className="h-full">
            <SpotlightCard className="h-full rounded-[2rem]" spotlightColor="rgba(34,72,163,0.15)">
              <div className="group bg-[#0A0A0C] border border-white/5 rounded-[2rem] p-8 lg:p-10 flex flex-col hover:bg-[#0F0F13] hover:border-brand/30 hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(34,72,163,0.1)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] h-full relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.04)]">
                ...
                <div className="w-full h-[3px] bg-white/5 rounded-full mb-8 overflow-hidden">
                  <div className="h-full relative" style={{ width: '96%', background: 'linear-gradient(to right, #2248A3, #7898E6)' }}>
                    <div className="absolute inset-0 bg-white/20 animate-[scanlineMove_2s_linear_infinite]"></div>
                  </div>
                </div>
                
                <h3 className="font-heading text-xl font-bold text-white mb-4 group-hover:text-brand transition-colors duration-300">Visual Programming</h3>
                <p className="text-[15px] text-text-2 leading-relaxed mb-8 flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  ...
                  <span className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-mono text-text-2 group-hover:border-brand/20 group-hover:text-text-1 transition-all duration-300">Parametric Design</span>
                </div>
              </div>
            </SpotlightCard>
          </Reveal>

          {/* Card 3 — BIM Coordination */}
          <Reveal delay={300} className="h-full">
            <SpotlightCard className="h-full rounded-[2rem]" spotlightColor="rgba(34,72,163,0.15)">
              <div className="group bg-[#0A0A0C] border border-white/5 rounded-[2rem] p-8 lg:p-10 flex flex-col hover:bg-[#0F0F13] hover:border-brand/30 hover:-translate-y-2 hover:shadow-[0_16px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(34,72,163,0.1)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] h-full relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.04)]">
                ...
                <div className="w-full h-[3px] bg-white/5 rounded-full mb-8 overflow-hidden">
                  <div className="h-full relative" style={{ width: '85%', background: 'linear-gradient(to right, #2248A3, #7898E6)' }}>
                    <div className="absolute inset-0 bg-white/20 animate-[scanlineMove_2s_linear_infinite]"></div>
                  </div>
                </div>
                
                <h3 className="font-heading text-xl font-bold text-white mb-4 group-hover:text-brand transition-colors duration-300">BIM Coordination</h3>
                <p className="text-[15px] text-text-2 leading-relaxed mb-8 flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  ...
                  <span className="px-3 py-1 bg-white/5 border border-white/5 rounded-full text-[10px] font-mono text-text-2 group-hover:border-brand/20 group-hover:text-text-1 transition-all duration-300">Data Dashboards</span>
                </div>
              </div>
            </SpotlightCard>
          </Reveal>
