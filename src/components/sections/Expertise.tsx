      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
          ...
          <Reveal delay={100} className="h-full">
            ...
            <SpotlightCard className="h-full rounded-[calc(2rem-3px)]" spotlightColor="rgba(34,72,163,0.15)">
              {/* Double-Bezel inner core */}
              <div className="group bg-[#0A0A0C] border border-white/5 rounded-[calc(2rem-3px)] p-8 lg:p-10 flex flex-col hover:bg-[#0F0F13] hover:border-brand/30 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(34,72,163,0.12)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] h-full relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
          ...
          <Reveal delay={200} className="h-full">
            <div className="h-full p-[3px] rounded-[2rem] bg-white/[0.03] ring-1 ring-white/[0.08] shadow-[inset_0_1px_1px_rgba(255,255,255,0.06)]">
            <SpotlightCard className="h-full rounded-[calc(2rem-3px)]" spotlightColor="rgba(34,72,163,0.15)">
              <div className="group bg-[#0A0A0C] border border-white/5 rounded-[calc(2rem-3px)] p-8 lg:p-10 flex flex-col hover:bg-[#0F0F13] hover:border-brand/30 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(34,72,163,0.15)] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] h-full relative overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent group-hover:via-brand/50 transition-colors duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]"></div>
              ...
              <div className="w-full h-1 bg-white/5 rounded-full mb-8 overflow-hidden">
                <div className="h-full relative" style={{ width: '96%', background: 'linear-gradient(to right, #2248A3, #7898E6)' }}></div>
              </div>
          ...
          <Reveal delay={300} className="h-full">
            ...
            <SpotlightCard className="h-full rounded-[calc(2rem-3px)]" spotlightColor="rgba(34,72,163,0.15)">
              ...
              <div className="w-full h-1 bg-white/5 rounded-full mb-8 overflow-hidden">
                <div className="h-full relative" style={{ width: '85%', background: 'linear-gradient(to right, #2248A3, #7898E6)' }}></div>
              </div>
