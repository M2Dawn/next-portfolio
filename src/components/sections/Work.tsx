        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(400px,auto)]">
          ...
          <Reveal className="col-span-1 md:col-span-7 h-full" delay={100}>
            ...
            <SpotlightCard className="h-full rounded-[1.5rem]" spotlightColor="rgba(168, 85, 247, 0.15)">
              ...
              <div className="relative h-[220px] mt-auto rounded-xl overflow-hidden border border-white/5 bg-[#121216] group-hover:border-white/10 transition-colors shadow-inner -mx-4 -mb-4 lg:-mx-6 lg:-mb-6">
                <Image src="/images/clash-dashboard-hero.png" alt="Clash Detection Dashboard" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover object-top opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
              </div>
            </a>
            </SpotlightCard>
          </Reveal>
          ...
          <Reveal className="col-span-1 md:col-span-5 h-full" delay={300}>
            ...
            <SpotlightCard className="h-full rounded-[1.5rem]" spotlightColor="rgba(6, 182, 212, 0.15)">
              ...
              <div className="relative h-[220px] mt-auto rounded-xl overflow-hidden border border-white/5 bg-[#121216] group-hover:border-white/10 transition-colors shadow-inner -mx-4 -mb-4 lg:-mx-6 lg:-mb-6">
                <Image src="/images/model-health-hero.png" alt="Model Health Dashboard" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover object-top opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
              </div>
            </a>
            </SpotlightCard>
          </Reveal>
          ...
          <Reveal className="col-span-1 md:col-span-7 h-full" delay={400}>
            ...
            <SpotlightCard className="h-full rounded-[1.5rem]" spotlightColor="rgba(249, 115, 22, 0.15)">
              ...
              <div className="relative h-[220px] mt-auto rounded-xl overflow-hidden border border-white/5 bg-[#121216] group-hover:border-white/10 transition-colors shadow-inner -mx-4 -mb-4 lg:-mx-6 lg:-mb-6">
                <Image src="/images/sheet-manager-hero.png" alt="Sheet Manager Plugin" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover object-top opacity-70 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700" />
              </div>
            </a>
            </SpotlightCard>
          </Reveal>
