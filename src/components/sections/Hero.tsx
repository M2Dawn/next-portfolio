  ...
  return (
    <section className="relative overflow-hidden pt-24 pb-20 md:pt-28 md:pb-32 min-h-[100dvh] flex items-center bg-[#050507]" id="hero">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[30%] -right-[5%] w-[45%] h-[45%] rounded-full bg-[radial-gradient(circle,rgba(58,90,128,0.02)_0%,transparent_65%)] blur-[120px]"></div>
      </div>
      {/* Blueprint grid — architectural crosshair pattern */}
      <div className="absolute inset-0 pointer-events-none z-0"
        style={{
          backgroundImage: `
            linear-gradient(to right, rgba(58,90,128,0.03) 1px, transparent 1px),
            linear-gradient(to bottom, rgba(58,90,128,0.03) 1px, transparent 1px),
            linear-gradient(to right, rgba(58,90,128,0.015) 1px, transparent 1px),
            linear-gradient(to bottom, rgba(58,90,128,0.015) 1px, transparent 1px)
          `,
      ...
      <div className="max-w-[1200px] mx-auto px-6 w-full relative z-10 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-10 items-center">
        ...
        <div className="w-full max-w-[650px] lg:max-w-full relative">
          <Reveal>
            {/* Status Pill */}
            <div className="inline-flex items-center gap-2.5 text-[11px] md:text-[13px] font-semibold tracking-wide text-text-1 mb-6 md:mb-8 px-4 py-2 rounded-full bg-white/[0.03] border border-white/10 backdrop-blur-xl shadow-[0_0_20px_rgba(58,90,128,0.1)] hover:bg-white/10 transition-colors cursor-default">
          ...
          <Reveal delay={300}>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10 md:mb-12">
              ...
              <Link href="#work" className="group relative inline-flex items-center justify-center gap-3 px-6 py-3.5 md:px-8 md:py-4 rounded-xl font-bold text-white bg-white/5 border border-white/10 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] overflow-hidden shadow-[0_0_40px_rgba(58,90,128,0.15)] hover:shadow-[0_0_60px_rgba(58,90,128,0.35)] hover:-translate-y-1">
                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-brand via-slate-400 to-brand opacity-90 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div className="w-full relative mt-16 lg:mt-0 flex flex-col gap-6">
          <Reveal delay={300} className="relative z-10">
            {/* Glow behind mockup */}
            <div className="absolute -inset-4 bg-gradient-to-b from-brand/20 via-slate-500/10 to-transparent rounded-[2rem] blur-2xl opacity-60 pointer-events-none"></div>
          ...
          <Reveal delay={400} className="flex flex-wrap items-center justify-center lg:justify-start gap-3 w-full">
            ...
            <div className="flex items-center gap-2.5 bg-[#121216]/90 border border-white/10 rounded-xl px-4 py-2 text-xs font-bold text-text-1 shadow-lg backdrop-blur-xl">
              <svg className="text-slate-400" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
